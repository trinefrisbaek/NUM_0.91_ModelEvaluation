...
contains
  ...
  subroutine read_namelist()
    ...
    namelist /input_generalists / epsilonL, alphaL, alphaN,rLstar, rNstar, epsilonF, &
             & alphaF, cF, beta, sigma, cLeakage, delta, alphaJ, cR, &
             & remin, remin2, reminF, mMinGeneralist, mMaxGeneralist, rhoval
  ...
  subroutine initGeneralists(this, n)
    ...
    integer, intent(in):: n
    integer:: i
    real(dp):: rho! = rhoval*1d6*1d-12
	
	call read_namelist()
    
	rho = rhoval*1d6*1d-12
