...
! ==========================================================================
  subroutine read_namelist_spec()
    integer :: file_unit,io_err
	!real(dp) :: mort2val

    namelist /input_spec / mort2val


    call open_inputfile(file_unit, io_err)
        read(file_unit, nml=input_spec, iostat=io_err)
        call close_inputfile(file_unit, io_err)
		
		!mort2val2=mort2val

  end subroutine read_namelist_spec
  ...
  subroutine calcGrid()
    ...
    this%mort2constant =mort2val/log(this%m(2) / this%m(1))
